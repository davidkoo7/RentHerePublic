...
public class ItemDB
{
    ...
    public static List<Item> getAllItem()
    {
        ...
        try
        {
            SqlCommand command = new SqlCommand("SELECT * FROM Item WHERE pricePerDay <>NULL OR pricePerWeek <> NULL OR pricePerMonth <> NULL");
    ...
    public static List<Item> searchItembyName(string keyword, string location, string categoryName)
    {
        ...
        try
        {
            ...
            string sqlcommand = "SELECT * FROM Item WHERE name LIKE @name AND ( pricePerDay <>NULL OR pricePerWeek <> NULL OR pricePerMonth <> NULL ) ";
