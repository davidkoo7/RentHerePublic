                            ...
                            <div class="row">
                                <div class="content-product-left  col-sm-6 col-xs-12 ">
                                    <div class="large-image  ">
                                        <img itemprop="image" class="product-image-zoom" src="/image/item/<%# DataBinder.Eval(Container.DataItem, "img1") %>"  data-zoom-image="/image/item/<%# DataBinder.Eval(Container.DataItem, "img1") %>"  title="Bint Beef" alt="Bint Beef">
                                    </div>

                                    <div id="thumb-slider" class="owl-theme owl-loaded owl-drag full_slider">
                                        <a data-index="0" class="img thumbnail " data-image="/image/item/<%# DataBinder.Eval(Container.DataItem, "img2") %>"  title="Bint Beef">
                                            <img src="/image/item/<%# DataBinder.Eval(Container.DataItem, "img2") %>"  title="Bint Beef" alt="Bint Beef">
                                        </a>
                                        &nbsp;&nbsp;<a data-index="1" class="img thumbnail " data-image="/image/item/<%# DataBinder.Eval(Container.DataItem, "img3") %>"  title="Bint Beef"><img src="/image/item/<%# DataBinder.Eval(Container.DataItem, "img3") %>"  title="Bint Beef" alt="Bint Beef">
                                        </a>
                                        &nbsp;&nbsp;<a data-index="02" class="img thumbnail " data-image="/image/item/<%# DataBinder.Eval(Container.DataItem, "img4") %>"  title="Bint Beef"><img src="/image/item/<%# DataBinder.Eval(Container.DataItem, "img4") %>"  title="Bint Beef" alt="Bint Beef">
                                        </a>
                                    &nbsp;&nbsp;</div>
                                ...
                                <div class="content-product-right col-sm-6 col-xs-12">
                                    ...
                                    <div class="product-label form-group">
										...
										<span class="price-new" itemprop="price"><asp:Label ID="lblPricePerDay" runat="server" Text='<%# String.Format("{0:c}", Eval("pricePerDay")) %>' /></span>
                                            <span class="price-old" style="font-size: 20;text-decoration: none">per day</span>
                                        </div>
                                    </div>
                                    <div class="product-label form-group">
                                        <div class="product_page_price price" itemprop="offerDetails" itemscope="" itemtype="http://data-vocabulary.org/Offer">
										<span class="price-new" itemprop="price"><asp:Label ID="lblPricePerWeek" runat="server" Text='<%# String.Format("{0:c}", Eval("pricePerWeek")) %>' /></span>
                                            <span class="price-old" style="font-size: 20;text-decoration: none">per week</span>
                                        </div>
                                    </div>
                                    <div class="product-label form-group">
                                        <div class="product_page_price price" itemprop="offerDetails" itemscope="" itemtype="http://data-vocabulary.org/Offer">
										<span class="price-new" itemprop="price"><asp:Label ID="lblPricePerMonth" runat="server" Text='<%# String.Format("{0:c}", Eval("pricePerMonth")) %>' /></span>
                                            <span class="price-old" style="font-size: 20;text-decoration: none">per month</span>
                                        </div>
                                    </div>
                                    <div class="product-box-desc">
                                        <div class="inner-box-desc">
										<div class="price-tax"><span>Refundable Deposit: </span><asp:Label ID="lblDeposit" runat="server" Text='<%# Eval("deposit") %>' /></div>
                                            <div class="reward"><span>Price</span></div>
                                            <div class="brand"><span>- Day:</span></div>
                                            <div class="model"><span>- Week:</span> Product 15</div>
                                            <div class="reward"><span>- Month:</span> 100</div>
                                        </div>
                                    </div>
...
<%--										<div class="reward"><span>User: <asp:Label ID="lblRenterName" runat="server" Text='<%# Eval("renterID") %>' /> </span></div>--%>
                                    ...
                                    <div id="product">
                                        ...
                                        <div class="form-group box-info-product">
                                            <div class="cart">
                                                <input type="button" data-toggle="tooltip" title="" value="Rent Now" data-loading-text="Loading..." id="button-cart" class="btn btn-mega btn-lg" data-original-title="Rent Now">
                                            </div>
